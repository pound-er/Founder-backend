# Generated by Django 3.0.8 on 2022-07-07 01:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_productmedia', to='api.Product')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='brand',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='brand_product', to='api.Type'),
        ),
        migrations.AddField(
            model_name='product',
            name='type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('magazine_content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='magazinecontent_brand', to='api.MagazineContent')),
            ],
        ),
    ]
